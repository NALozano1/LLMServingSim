...
class Scheduler:
    ...
    def on_segment_done(self, batch_id, sys, finish):
        ...
        if self.pd_type != "prefill":
            ...
            # prefill instances span a doubled NPU range; forward_segments is
            # gated to colocated (pd_type=null) single-NPU instances in
            # serving/__main__.py so this branch is not reached under segments.
