#!/usr/bin/env bash
# Submit V100 smoke: in-place layer-boundary DVFS pause (profiler dense slice).
#
#   export HF_TOKEN=...
#   ./profiler/jobs/submit_arc_v100_layer_dvfs_smoke.sh
#
set -euo pipefail

ROOT="/data/engs-glass/engs2950/DVFS-MoE/LLMServingSim"
RUNNER="${ROOT}/profiler/jobs/run_arc_v100_layer_dvfs_smoke.sh"
...
TIME="${TIME:-00:30:00}"
JOB_NAME="llmsim_layer_dvfs_smoke"
