...
**Tracked spec (this repo):** `bench/docs/v100_bench_layer_dvfs_mini3x3_{replication,permutations,campaign_spec}.{md,json}`  
**Runtime outputs:** `bench/campaigns/v100_bench_layer_dvfs_mini3x3/runs/<run_id>/` (gitignored)
