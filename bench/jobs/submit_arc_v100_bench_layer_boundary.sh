#!/usr/bin/env bash
# Submit real vLLM bench layer-boundary DVFS smoke.
#
#   export HF_TOKEN=...
#   MODEL=microsoft/Phi-tiny-MoE-instruct ./bench/jobs/submit_arc_v100_bench_layer_boundary.sh
#
set -euo pipefail

ROOT="/data/engs-glass/engs2950/DVFS-MoE/LLMServingSim"
RUNNER="${ROOT}/bench/jobs/run_arc_v100_bench_layer_boundary.sh"
...
TIME="${TIME:-01:00:00}"
JOB_NAME="llmsim_bench_layer_dvfs"
...
echo "  out: ${ROOT}/bench/results/V100_layer_dvfs/<model>/tp1/${jid}/"
